...
session_start();
if (!isset($_SESSION['id']) || !$_SESSION['status'] == 'ativo'):
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="view.php">Ordem Alfabética</a></li>
                                <li><a href="viewByCia.php">Ordem por Lotação</a></li>
                                <li><a href="viewByPontos.php">Ordem por Pontos</a></li>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="text-align: justify">
                                    <p>Promover a valorização do público interno das Unidades do CPOS,
